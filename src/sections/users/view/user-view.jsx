        ...
        <>
            <Stack direction="row" columnGap={1} justifyContent="space-between" alignItems="center" sx={{ bgcolor: '#fff', width: '100%', height: '64px', px: 3, borderBottom: "1px solid #F3F4F6" }} >
                ...
                <Stack direction="row" alignItems="center" columnGap={1}  >
                    ...
                    <Button
                        sx={{ color: '#FFFFFF', fontSize: "13px", lineHeight: "20.8px", fontWeight: '500', fontFamily: 'Manrope', bgcolor:"#415BE7", borderRadius:"7px", p:1 , width:"89px", textAlign:'center'}}
                        endIcon={< AddIcon sx={{ color: '#FFFFFF', fontSize: "23.2px" }} />} >
                        Create 
                    </Button>
                </Stack>
